...
def int_func(str): # функция перевода певрой буквы в заглавную
    first_char = str[0].upper()
    result_str = first_char + str[1:]
    return result_str


for str in input("Введите слова через пробел:").split():
    str = int_func(str)
    print(str, end=' ')
